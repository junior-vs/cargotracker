...
import static tech.studio.rest.cargotracker.domain.model.cargo.RoutingStatus.MISROUTED;
import static tech.studio.rest.cargotracker.domain.model.cargo.RoutingStatus.NOT_ROUTED;
import static tech.studio.rest.cargotracker.domain.model.cargo.RoutingStatus.ROUTED;
import static tech.studio.rest.cargotracker.domain.model.cargo.TransportStatus.CLAIMED;
import static tech.studio.rest.cargotracker.domain.model.cargo.TransportStatus.IN_PORT;
import static tech.studio.rest.cargotracker.domain.model.cargo.TransportStatus.NOT_RECEIVED;
import static tech.studio.rest.cargotracker.domain.model.cargo.TransportStatus.ONBOARD_CARRIER;
import static tech.studio.rest.cargotracker.domain.model.cargo.TransportStatus.UNKNOWN;
...
import tech.studio.rest.cargotracker.domain.model.handling.HandlingEvent;
import tech.studio.rest.cargotracker.domain.model.handling.HandlingHistory;
import tech.studio.rest.cargotracker.domain.model.location.Location;
import tech.studio.rest.cargotracker.domain.model.voyage.Voyage;
import tech.studio.rest.cargotracker.domain.shared.DomainObjectUtils;
...
public class Delivery implements Serializable {
  ...
  public HandlingActivity getNO_ACTIVITY() {
    return NO_ACTIVITY;
  }
