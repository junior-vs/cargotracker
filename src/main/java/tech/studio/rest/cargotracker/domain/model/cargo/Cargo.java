 ...
 *
 * <p>The cargo aggregate, and the entire domain model, is built to solve the problem of booking
 * and tracking cargo. All important business rules for determining whether or not a cargo is
